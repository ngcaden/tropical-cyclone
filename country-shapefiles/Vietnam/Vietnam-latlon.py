...
m1.readshapefile(shapefile = \
    '/Users/nguyenquang30795/Desktop/BSc Project/country-shapefiles/Vietnam/VNM_adm0', \
    name = 'vn')
...
shape = 0
while shape < len(map.Vietnam):
    # Calculate areas of each island
    area = PolygonArea(map.Vietnam[shape])
    Area.append([area,m1.vn[shape],map.Vietnam[shape]])
    shape += 1

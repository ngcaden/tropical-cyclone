...
m1.readshapefile(shapefile = \
    '/Users/nguyenquang30795/Desktop/BSc Project/country-shapefiles/South Korea/KOR_adm0', \
    name = 'kor')
...
while shape < len(map.Korea):
    ...
    Area.append([area,m1.kor[shape],map.Korea[shape]])
    shape += 1

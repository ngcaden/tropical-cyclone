...
m1.readshapefile(shapefile = \
    '/Users/nguyenquang30795/Desktop/BSc Project/country-shapefiles/Laos/LAO_adm0', \
    name = 'laos')
...
shape = 0
while shape < len(map.Laos):
    # Calculate areas of each island
    area = PolygonArea(map.Laos[shape])
    Area.append([area,m1.laos[shape],map.Laos[shape]])
    shape += 1

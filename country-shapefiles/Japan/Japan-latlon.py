...
m1.readshapefile(shapefile = \
    '/Users/nguyenquang30795/Desktop/BSc Project/country-shapefiles/Japan/JPN_adm0', \
    name = 'JPN')
...
shape = 0
while shape < len(map.Japan):
    # Calculate areas of each islan
    area = PolygonArea(map.Japan[shape])
    Area.append([area,m1.JPN[shape],map.Japan[shape]])
    shape += 1

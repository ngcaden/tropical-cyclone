...
m1.readshapefile(shapefile = \
    '/Users/nguyenquang30795/Desktop/BSc Project/country-shapefiles/North Korea/PRK_adm0', \
    name = 'prk')
...
shape = 0
while shape < len(map.Korea):
    # Calculate areas of each islan
    area = PolygonArea(map.Korea[shape])
    Area.append([area,m1.prk[shape],map.Korea[shape]])
    shape += 1
